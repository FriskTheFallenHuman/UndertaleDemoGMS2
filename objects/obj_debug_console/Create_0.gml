...
history_file_name = "console_log.txt"	// what do you want the save file to be called 
...
history_text_col =			make_colour_rgb(255,255,255)
history_text_col_info =		make_colour_rgb(255,240,0)
history_text_col_focus =	make_colour_rgb(255,240,104)
history_text_col_hover =	make_colour_rgb(160,160,160)
history_text_alpha =		1
history_text_shadow =		0.2 // 0=off, 1=full on, decimal=amount of opacity 
history_border_col =		make_colour_rgb(255,255,255)
...
main_border_col =			make_colour_rgb(255,255,255)
main_border_alpha =			1
...
predict_border_col =		make_colour_rgb(255,255,255)
predict_border_alpha =		1
...
pos_height = 230 // how tall the history area is (the textbox starts after this)
pos_margin_sides = 54 // how far away from the sides the box should be 
...
#endregion
#region font
font_for_main = fnt_maintext
#endregion
#region only 1 of this object allowed 
if (instance_number(obj_debug_console) < 1) {
	instance_destroy()
}
#endregion
...
commands[command_1.undertale] = "undertale"
...
#region second level commands 
	...
	#region variable
		var i = 0
		second_level[command_1.undertale,i++] = "give_exp"
		second_level[command_1.undertale,i++] = "give_lv"
		second_level[command_1.undertale,i++] = "give_gold"
		second_level[command_1.undertale,i++] = "give_item"
		second_level[command_1.undertale,i++] = "encounter"
	#endregion
	#region game
		var i = 0
		...
		second_level[command_1.game,i++] = "quit"
		second_level[command_1.game,i++] = "save"
		second_level[command_1.game,i++] = "tempsave"
		second_level[command_1.game,i++] = "load"
		second_level[command_1.game,i++] = "tempload"
